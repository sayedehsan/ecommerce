...
@section('content')
    ...
    <!--============================
        BANNER PART 2 START
    ==============================-->
    @include('frontend.home.sections.cover-slider')
    <!--============================
        BANNER PART 2 END
    ==============================-->
   ...
   @include('frontend.home.sections.flash-sell')
    ...
    <!--============================
        BRAND SLIDER START
    ==============================-->
    @include('frontend.home.sections.brands-slider')
    <!--============================
        BRAND SLIDER END
    ==============================-->
    ...
    ==============================-->
    @include('frontend.home.sections.first-category')
    <!--============================
        ELECTRONIC PART END  
    ==============================-->
    ...
    <!--============================
        ELECTRONIC PART START  
    ==============================-->
    @include('frontend.home.sections.second-category')
    <!--============================
        ELECTRONIC PART END  
    ==============================-->
